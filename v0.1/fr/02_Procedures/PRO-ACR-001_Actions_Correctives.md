...
| Responsabilite | Qui |
|---|---|
| Decider de l'ouverture d'une AC | Roxane Wicky, gerante |
| Analyser les causes (dans la mesure des competences de la gerante) | Roxane Wicky, gerante (avec les partenaires chinois si NC de fabrication) |
| Definir l'action corrective | Roxane Wicky, gerante |
| Mettre en oeuvre ou coordonner la mise en oeuvre | Roxane Wicky, gerante (ou partenaire chinois) |
| Verifier l'efficacite | Roxane Wicky, gerante |
...
> **Principe directeur :** Les actions correctives de Plus Sarl visent a prevenir la recurrence et a reduire l'impact sur le client. La gerante agit dans la mesure de ses competences et s'appuie sur ses partenaires chinois pour les aspects techniques de la fabrication.
...
| **Source** | [ ] Reclamation client [ ] Retard transport [ ] Retard production [ ] Defaut production [ ] Audit interne [ ] Audit externe [ ] Autre |
...
| **Partenaire implique dans l'analyse** | [ ] Yuyao Mould Factory [ ] Second partenaire [nom A CONFIRMER] [ ] Transporteur [ ] Analyse interne uniquement |
...
| Repartition par type (transport, production, retard) | Information | Trimestriel |
...
> 4. Impliquez les partenaires chinois (Yuyao Mould Factory ou le second partenaire) dans l'analyse quand la NC vient de la fabrication
> 5. Documentez les echanges (emails, WeChat) comme preuves des actions correctives
> 6. L'auditeur verifiera que vos AC sont efficaces (pas juste sur papier)
