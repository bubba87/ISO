# Competencies and Training Register
...
## 1. Competencies Sheet — Managing Director

### Identification

| Element | Detail |
|---|---|
| **Name and surname** | :green_circle: Roxane Wicky |
| **Position** | :green_circle: Managing Director / Director / Quality Manager |
| **Start date** | :green_circle: 2007 (founder of Plus Sarl) |
| **Functions held** | :green_circle: General management, Quality manager, Sales, Purchasing, Technical coordination, Logistics, Administration |
| **Status** | :green_circle: Sole employee of the company |
...
| Function | Required competencies | Current level | Training needed? |
|---|---|---|---|
...
| Date | Training | Organization | Duration | Certificate | Comment |
|---|---|---|---|---|---|
| :red_circle: [TO BE COMPLETED — not disclosed] | :red_circle: [TO BE COMPLETED — potential previous training — not disclosed] | :red_circle: [TO BE COMPLETED — not disclosed] | :red_circle: [TO BE COMPLETED — not disclosed] | [ ] Yes [ ] No | :red_circle: [TO BE COMPLETED — not disclosed] |
| :red_circle: [TO BE COMPLETED] | Understanding ISO 9001:2015 | :red_circle: [TO BE COMPLETED — if already completed] | :red_circle: [TO BE COMPLETED] | [ ] Yes [ ] No | :yellow_circle: [RECOMMENDED — training recommended as part of SQS certification] |

> **:red_circle: [TO BE COMPLETED — not disclosed]**: Verify if Roxane Wicky has already completed ISO 9001 training or other
> relevant professional training. Document all past training.
> The SQS auditor will review this register — training evidence is essential.
...
|---|---|---|---|---|---|---|
| 1 | Understanding ISO 9001:2015 (1-2 days) | Master the standard requirements to fulfill the quality manager role | :yellow_circle: High | :red_circle: [TO BE COMPLETED] | :blue_circle: [TO BE VERIFIED — CHF 500 - 1'500] | [ ] Planned [ ] Completed [ ] Postponed |
| 2 | :red_circle: [TO BE COMPLETED — other identified training] | :red_circle: [TO BE COMPLETED — Objective] | :red_circle: [TO BE COMPLETED — Priority] | :red_circle: [TO BE COMPLETED — Quarter] | :red_circle: [TO BE COMPLETED — CHF] | [ ] Planned [ ] Completed [ ] Postponed |

### Recommended training

| Training | Why | Possible organization | Estimated budget |
|---|---|---|---|
| Understanding ISO 9001:2015 (1-2 days) | Know the standard requirements — :red_circle: [TO BE COMPLETED — if already completed] | :yellow_circle: [RECOMMENDED: SQS, SAQ, or other Swiss organization] | :blue_circle: [TO BE VERIFIED — CHF 500 - 1'500] |
| ISO 9001 internal auditor (optional) | Understand the audit process to prepare for internal and external audits | :yellow_circle: [RECOMMENDED: SQS, SAQ] | :blue_circle: [TO BE VERIFIED — CHF 800 - 2'000] |
| Import/export customs regulations (if needed) | Strengthen competencies in China-Europe customs compliance | [Specialized] | Variable |
...
| Competency area | Rating (1-5) | Evolution vs Y-1 | Action if necessary |
|---|---|---|---|
...
> 1. Complete the competencies sheet with the actual background of Roxane Wicky (diplomas, previous experience) — currently not disclosed
> 2. Keep copies of diplomas and training certificates
> 3. Plan at least 1 training per year related to quality
> 4. The SQS auditor will verify that competencies are consistent with functions held
> 5. Update this document at least once per year
> 6. ISO 9001 competency is currently "in progress" — high priority for 2026
> 7. Competency maintenance through daily experience and continuous communication is valid, but must be complemented by documented formal training
> 8. SQS and SAQ are recommended organizations for ISO 9001 training in Switzerland
> 9. Coordinate with Paradiso fiduciary for training budget aspects if necessary
