# Dossier d'Audit — Index Structure par Chapitre ISO 9001:2015
...
Ce document constitue l'index de référence du dossier d'audit ISO 9001:2015 de Plus Sarl. Il permet à l\'auditeur SQS de localiser rapidement chaque exigence de la norme dans la documentation du SMQ.

Le dossier est organisé selon la structure de la norme ISO 9001:2015 (chapitres 4 a 10).

---

## Vue d'ensemble du SMQ
...
## Correspondance ISO 9001:2015 — Documents SMQ

### Chapitre 4 — Contexte de l'organisme

| Clause ISO | Exigence | Document(s) SMQ | Section(s) | Statut |
|---|---|---|---|---|
| 4.1 | Compréhension de l'organisme et de son contexte | CTX-QUA-001 | Sections 1, 2 (SWOT) | 🟢 |
| 4.2 | Compréhension des besoins et attentes des parties intéressées | CTX-QUA-001 | Section 3 | 🟢 |
| 4.3 | Détermination du domaine d'application du SMQ | DOM-QUA-001 | Sections 1-5 | 🟢 |
| 4.4 | SMQ et ses processus | CRT-QUA-001 | Sections 1-6 | 🟢 |

### Chapitre 5 — Leadership

| Clause ISO | Exigence | Document(s) SMQ | Section(s) | Statut |
|---|---|---|---|---|
| 5.1 | Leadership et engagement | M1-DIR-001 | Sections 2, 2.3 | 🟢 |
| 5.1.2 | Orientation client | M1-DIR-001 | Section 2.2 | 🟢 |
| 5.2 | Politique qualité | POL-QUA-001 | Document complet | 🟢 |
| 5.3 | Roles, responsabilités et autorites | M1-DIR-001 | Sections 3, 4, 5, 6 | 🟢 |

### Chapitre 6 — Planification

| Clause ISO | Exigence | Document(s) SMQ | Section(s) | Statut |
|---|---|---|---|---|
| 6.1 | Actions a mettre en œuvre face aux risques et opportunités | CTX-QUA-001 | Section 5 (5.1 a 5.4) | 🟢 |
| 6.2 | Objectifs qualité et planification des actions | OBJ-QUA-001 | Sections 1-3 | 🟢 |
| 6.3 | Planification des modifications | CTX-QUA-001 | Section 6 (6.1 a 6.4) | 🟢 |
...
| Clause ISO | Exigence | Document(s) SMQ | Section(s) | Statut |
|---|---|---|---|---|
| 8.1 | Planification et maîtrise opérationnelles | CRT-QUA-001 | Section 3 (flux principal) | 🟢 |
| 8.2 | Exigences relatives aux produits et services | CTX-QUA-001, M1-DIR-001 | CTX §1.2, 1.3 ; M1 §6 | 🟢 |
| 8.2.1 | Communication avec les clients | M1-DIR-001 | Section 7.2 | 🟢 |
...
| 8.7 | Maîtrise des éléments de sortie non conformes | PRO-NCF-001 | Document complet | 🟢 |
...
## Liste des documents du SMQ (par categorie)

### 01 — Documents obligatoires

| # | Référence | Titre | Clauses ISO couvertes |
|---|---|---|---|
| 1 | DOM-QUA-001 | Domaine d'application du SMQ | 4.3 |
| 2 | POL-QUA-001 | Politique Qualité | 5.2 |
| 3 | OBJ-QUA-001 | Objectifs Qualité | 6.2 |
| 4 | CTX-QUA-001 | Contexte de l'Organisation | 4.1, 4.2, 6.1, 6.3, 7.1, 7.4 |
| 5 | CRT-QUA-001 | Cartographie des Processus (+.drawio) | 4.4 |
| 6 | M1-DIR-001 | Leadership et Attribution des Responsabilités | 5.1, 5.3, 8.2 |
| 7 | FIC-PRO-001 | Fiche Processus O2 — Achats et Sous-traitance | 8.4 |
| 8 | FIC-PRO-002 | Fiche Processus O3 — Logistique et Livraison | 8.5 |

### 02 — Procédures

| # | Référence | Titre | Clauses ISO couvertes |
|---|---|---|---|
| 9 | PRO-DOC-001 | Maîtrise des Documents et Enregistrements | 7.5 |
| 10 | PRO-AUD-001 | Audit Interne | 9.2 |
| 11 | PRO-NCF-001 | Non-Conformites | 8.7, 10.2 |
| 12 | PRO-ACR-001 | Actions Correctives | 10.2 |
| 13 | PRO-ACH-001 | Achats et Sous-traitance | 8.4 |
| 14 | PRO-LOG-001 | Logistique et Livraison | 8.5 |

### 03 — Formulaires et Registres

| # | Référence | Titre | Clauses ISO couvertes |
|---|---|---|---|
| 15 | FOR-EVF-001 | Évaluation Fournisseurs | 8.4 |
| 16 | FOR-SAT-001 | Satisfaction Client | 9.1.2 |
