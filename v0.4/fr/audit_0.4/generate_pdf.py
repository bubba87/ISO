#!/usr/bin/env python3
"""
Generateur PDF du dossier d'audit ISO 9001:2015 — Plus Sarl
Combine MQ-001 + INDEX en un seul PDF pour transmission a SQS.
"""
...
@page {
    ...
    @bottom-center {
        content: "Plus Sarl — Manuel Qualite v0.4 — Page " counter(page) " / " counter(pages);
        font-size: 8pt;
        color: #666;
...
<div class="cover-page">
    <h1>MANUEL QUALITE</h1>
    <div class="subtitle">Systeme de Management de la Qualite<br>ISO 9001:2015</div>
    <hr style="width:200px; margin:30px auto; border-top:2px solid #1a365d;">
    <div class="company">Plus Sarl</div>
    <div class="info">Route de Montet 11, 1588 Cudrefin, Suisse</div>
    <div class="info">N. IDE : CH-645.4.101.228-7</div>
    <div class="info">Gerante : Roxane Wicky</div>
...
<div class="separator">
    <h1>PARTIE 2</h1>
    <div class="desc">INDEX DU DOSSIER D'AUDIT<br>
    Correspondance ISO 9001:2015 — Documents SMQ</div>
</div>
"""
...
def main():
    ...
    output_path = os.path.join(SCRIPT_DIR, 'DOSSIER_AUDIT_ISO9001_Plus_Sarl_v0.4.pdf')

    print("Generation du PDF du dossier d'audit ISO 9001...")
