# Variante 3B — Politique Qualité : Remplacement par UPDATE 5.2
...
| **Rédigé par** | Direction Plus Sarl |
| **Approuve par** | Direction Plus Sarl |

> **Légende :** 🟢 = déjà rempli

> **Source :** UPDATE 5.2 — Manuel de qualité (19/02/2026) 🟢
...
L'activité de l'entreprise repose sur la coordination industrielle entre des clients situés principalement en Europe et des partenaires de fabrication localisés en Chine.

Dans ce contexte, constituent des priorités :
...
Afin d'atteindre ces objectifs, la direction s'engage a :
...
Fait a Cudrefin, le 19 fevrier 2026 — Direction Plus Sarl

---

> **Note :** Les axes stratégiques qualité chiffrés (95% délais, max 3 NC/client/an, 24h réponse) qui figuraient dans la version précédente ne sont plus présents dans cette version. Ils sont définis dans OBJ-QUA-001.
