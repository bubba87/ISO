...
|------------------------|--------------------------------------------------------|
| M1 - Leadership        | Validation stratégie achats, budgets                   |
| P01 - Commercial       | Réception des besoins clients, retour faisabilité      |
| P03 - Logistique       | Coordination transport et réception internationale     |
| P04 - Contrôle Qualité | Inspections à la source, contrôle réception            |
| S1 - Gestion Documentaire | Archivage AQF, évaluations, commandes               |
