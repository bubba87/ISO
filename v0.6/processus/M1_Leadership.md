# M1 - Processus de Leadership et Pilotage

| **Processus**       | M1 - Leadership et Pilotage                          |
|----------------------|------------------------------------------------------|
| **Type**            | Management                                            |
| **Pilote**          | Direction                                             |
| **Version**         | v0.6                                                  |
| **Date**            | 2026-03-04                                            |
| **Référence**       | PR-M1-LEAD                                            |
...
La Direction établit des objectifs qualité mesurables, cohérents avec la politique qualité. Ces objectifs sont déclinés par processus et suivis trimestriellement (cf. FM-M1-OBJ).
...
La Direction conduit des revues de direction planifiées (minimum 2 par an) selon le format FM-M1-RD, intégrant toutes les données d'entrée requises par la norme ISO 9001:2015.
...
```
 ...
 DIRECTION            |  [A1 Définir]    [A2 Planifier]    [A3 Allouer]
                      ...
                      |  collaborateurs  (FM-M1-OBJ)         les moyens
                      |      |               |                   |
                      |      +-------+-------+-------------------+
                      |              |
                      |              v
...
| P03 - Logistique       | Suivi de la performance logistique internationale      |
| P04 - Contrôle Qualité | Résultats des inspections, taux de non-conformités     |
| S1 - Gestion Documentaire | Maîtrise des documents du SMQ                       |
...
| FM-M1-OBJ   | Objectifs Qualité                 | Formulaire    |
| FM-M1-RD    | Revue de Direction                 | Formulaire    |
| PR-M1-LEAD  | Procédure Leadership et Pilotage   | Procédure     |
| EN-M1-RISK  | Cartographie des risques           | Enregistrement|
