# S1 - Processus de Gestion Documentaire

| **Processus**       | S1 - Gestion Documentaire                            |
|----------------------|------------------------------------------------------|
| **Type**            | Support                                               |
...
Exemples : v0.1, v0.6, v1.0, v1.1, v2.0
...
- Registre documentaire à jour (FM-S1-GD)
...
Le Rôle Gestion Documentaire diffuse le document approuvé aux destinataires concernés, met à jour le registre documentaire (FM-S1-GD) et s'assure du retrait des versions obsolètes.
...
|------------------------|--------------------------------------------------------|
| M1 - Leadership        | Documents stratégiques, revue de direction             |
| P01 - Commercial       | Offres, contrats, enquêtes satisfaction                |
| P02 - Achats           | AQF, évaluations fournisseurs, commandes               |
| P03 - Logistique       | Documents de transport, preuves de livraison           |
| P04 - Contrôle Qualité | Rapports d'inspection, NC, audits                      |
...
| Code         | Intitulé                              | Type          |
|--------------|---------------------------------------|---------------|
| PR-S1-GD     | Procédure Gestion Documentaire       | Procédure     |
| FM-S1-GD     | Registre documentaire                 | Formulaire    |
| IT-S1-COD    | Instruction de codification           | Instruction   |
| FM-S1-DEM    | Demande de modification documentaire  | Formulaire    |
