# P04 - Processus Contrôle Qualité
...
- Fiches de non-conformité (FM-P04-NC)
- Décision de libération / refus / tri
- Rapports d'audit fournisseur (FM-P04-AUD)
...
Le Rôle Qualité identifie, enregistre et classifie les non-conformités selon 4 niveaux (cf. FM-P04-NC). Il conduit l'analyse des causes racines, définit les actions correctives et en assure le suivi.
...
|------------------------|--------------------------------------------------------|
| M1 - Leadership        | Reporting qualité, revue de direction, arbitrage NC    |
...
| P03 - Logistique       | Loading Check, libération pour expédition              |
| S1 - Gestion Documentaire | Archivage rapports, NC, audits                       |
...
| Code         | Intitulé                              | Type          |
|--------------|---------------------------------------|---------------|
| PR-P04-CQ    | Procédure Contrôle Qualité           | Procédure     |
| FM-P04-NC    | Fiche de Non-Conformité              | Formulaire    |
| FM-P04-AUD   | Rapport d'Audit Interne             | Formulaire    |
| FM-P04-IPC   | Rapport IPC                           | Formulaire    |
| FM-P04-DUPRO | Rapport DUPRO                        | Formulaire    |
| FM-P04-PSI   | Rapport PSI                           | Formulaire    |
| FM-P04-LC    | Rapport Loading Check                 | Formulaire    |
| IT-P04-ECH   | Instruction échantillonnage AQL      | Instruction   |
