...
# Manuel Qualité - Chapitre 4 : Contexte de l'Organisme
...
Plus Sarl évolue dans le secteur du monitoring industriel et du sourcing à l'échelle mondiale. La compréhension du contexte interne et externe est essentielle pour orienter le Système de Management de la Qualité.

### 4.1.1 Enjeux externes

| Catégorie          | Enjeux identifiés                                                              |
|--------------------|--------------------------------------------------------------------------------|
| Économique         | Fluctuations des taux de change, évolution des coûts de transport international|
| Réglementaire      | Conformité aux normes internationales, réglementations douanières multiples    |
| Technologique      | Digitalisation des échanges, outils de suivi à distance, plateformes en ligne  |
| Concurrentiel      | Présence de concurrents internationaux, pression sur les prix                  |
| Géopolitique       | Instabilité dans certaines régions, barrières commerciales internationales     |
| Environnemental    | Exigences croissantes en matière de durabilité et responsabilité sociale       |

### 4.1.2 Enjeux internes

| Catégorie          | Enjeux identifiés                                                              |
|--------------------|--------------------------------------------------------------------------------|
| Organisationnel    | Structure agile à taille humaine, nécessité de polyvalence des rôles           |
| Compétences        | Expertise technique en sourcing et qualité, maîtrise des langues étrangères    |
| Processus          | Maturité du SMQ, standardisation des méthodes de travail                       |
| Infrastructure     | Outils informatiques, moyens de communication, système documentaire            |
| Culture            | Orientation client, engagement qualité, amélioration continue                  |
...
| Dimension         | Éléments                                                                                          |
|-------------------|----------------------------------------------------------------------------------------------------|
| **Forces (S)**    | - Expertise reconnue en monitoring industriel international                                        |
|                   | - Réseau de fournisseurs qualifiés à travers le monde                                              |
|                   | - Structure agile permettant une réactivité élevée                                                 |
|                   | - Connaissance approfondie des normes qualité internationales                                      |
|                   | - Capacité d'intervention sur tous les continents                                                  |
| **Faiblesses (W)**| - Dépendance vis-à-vis de prestataires externes pour les inspections                               |
|                   | - Taille réduite limitant la capacité de traitement simultané                                      |
|                   | - Nécessité de renforcer la documentation des processus                                            |
|                   | - Système d'information à consolider                                                               |
| **Opportunités (O)**| - Demande croissante de services de sourcing qualifié à l'international                          |
|                   | - Développement de nouveaux marchés géographiques                                                  |
|                   | - Digitalisation des services d'inspection et de suivi                                             |
|                   | - Partenariats stratégiques avec des organismes d'inspection locaux                                |
|                   | - Certification ISO 9001 comme avantage concurrentiel                                              |
| **Menaces (T)**   | - Concurrence accrue sur le marché du sourcing international                                       |
|                   | - Risques logistiques liés aux transports internationaux                                           |
|                   | - Évolution rapide des exigences réglementaires dans différents pays                               |
|                   | - Risques de change et instabilité économique régionale                                            |

---

## 4.3 Parties intéressées pertinentes

### 4.3.1 Identification des parties intéressées

| Partie intéressée         | Besoins et attentes                                                      | Niveau d'influence |
|---------------------------|--------------------------------------------------------------------------|---------------------|
| Clients                   | Qualité des produits, respect des délais, transparence, traçabilité      | Élevé               |
| Fournisseurs internationaux| Relations équitables, cahier des charges clair, continuité de commandes | Élevé               |
| Collaborateurs (tous rôles)| Conditions de travail, formation, reconnaissance, stabilité             | Élevé               |
| Organismes d'inspection   | Cahier des charges précis, planification adéquate                        | Moyen               |
| Autorités réglementaires  | Conformité légale, déclarations conformes                                | Moyen               |
| Transitaires / logisticiens| Instructions claires, documentation complète                            | Moyen               |
| Partenaires financiers    | Pérennité de l'entreprise, solvabilité                                   | Moyen               |
| Concurrents               | Pratiques loyales du marché                                              | Faible              |

### 4.3.2 Surveillance des parties intéressées

| Partie intéressée         | Méthode de surveillance                | Fréquence         | Responsable       |
|---------------------------|----------------------------------------|--------------------|-------------------|
| Clients                   | Enquêtes de satisfaction, réclamations | Continue           | Rôle Commercial   |
| Fournisseurs              | Évaluations périodiques, audits        | Semestrielle       | Rôle Achats       |
| Collaborateurs            | Entretiens individuels, revues         | Annuelle           | Direction         |
| Autorités réglementaires  | Veille réglementaire                   | Continue           | Rôle Qualité      |

---

## 4.4 Domaine d'application du SMQ

### 4.4.1 Périmètre

Le Système de Management de la Qualité de Plus Sarl s'applique à l'ensemble des activités de **monitoring industriel et de sourcing à l'échelle mondiale**, incluant :

- La gestion commerciale et la relation client
- La sélection et la qualification des fournisseurs internationaux
- Le suivi de production et les inspections qualité
- La coordination logistique internationale
- La gestion documentaire du SMQ

### 4.4.2 Exclusions

| Clause ISO 9001:2015 | Exigence exclue                              | Justification                                                 |
|-----------------------|----------------------------------------------|---------------------------------------------------------------|
| 8.3                   | Conception et développement                   | Plus Sarl ne conçoit pas de produits ; la conception est réalisée par les clients ou les fournisseurs |

### 4.4.3 Sites couverts

Le SMQ couvre l'ensemble des opérations de Plus Sarl, indépendamment de la localisation géographique des interventions. Les inspections et audits sont réalisés sur les sites des fournisseurs partout dans le monde.

---

## 4.5 Système de management de la qualité et ses processus

### 4.5.1 Approche processus

Plus Sarl applique une approche processus conformément aux exigences de la norme ISO 9001:2015. Les processus sont définis, documentés et surveillés à l'aide d'indicateurs de performance.

### 4.5.2 Processus identifiés

| Type           | Code  | Processus                        | Entrées principales                    | Sorties principales                   |
|----------------|-------|----------------------------------|----------------------------------------|----------------------------------------|
| Management     | PM01  | Pilotage stratégique             | Contexte, exigences parties intéressées| Politique, objectifs, ressources       |
| Réalisation    | P01   | Gestion commerciale              | Demande client                         | Commande validée                       |
| Réalisation    | P02   | Achats et sourcing               | Cahier des charges                     | Fournisseur sélectionné, commande      |
| Réalisation    | P03   | Monitoring et contrôle qualité   | Commande fournisseur                   | Rapport d'inspection, décision         |
...
Les risques et opportunités associés à chaque processus sont identifiés et traités dans le chapitre 6 du présent Manuel Qualité (MQ_06_Planification).
...
| **Document**         | Évaluation Fournisseur                               |
|----------------------|------------------------------------------------------|
| **Code**            | FM-P02-EVAL                                           |
| **Processus**       | P02 - Achats et Sous-traitance                        |
| **Version**         | v0.7                                                  |
...
| **Pays**                  | ________________________________________         |
| **Adresse**               | ________________________________________         |
| **Contact principal**     | ________________________________________         |
| **Catégorie de produits/services** | ________________________________        |
| **Date de première qualification** | ________________________________       |
| **Date de l'évaluation**  | ________________________________________        |
| **Période évaluée**       | Du ______________ au ______________              |
| **Évaluateur (Rôle)**     | ________________________________________        |

---

## 2. Critères d'évaluation pondérés

L'évaluation repose sur **6 critères pondérés** pour un total de 100 points.

### Critère 1 : Qualité des produits/services (Pondération : 30 %)

| Sous-critère                                    | Note /10 | Commentaire |
|-------------------------------------------------|----------|-------------|
| Conformité aux spécifications techniques        | ___/10   |             |
| Taux de non-conformités sur la période          | ___/10   |             |
| Résultats des inspections (IPC, DUPRO, PSI)     | ___/10   |             |

**Note Critère 1 :** ___/10 x 30 % = ___/30

### Critère 2 : Respect des délais (Pondération : 20 %)

| Sous-critère                                    | Note /10 | Commentaire |
|-------------------------------------------------|----------|-------------|
| Taux de livraisons dans les délais convenus     | ___/10   |             |
| Fiabilité du planning de production communiqué  | ___/10   |             |
| Réactivité en cas de retard (communication)     | ___/10   |             |

**Note Critère 2 :** ___/10 x 20 % = ___/20

### Critère 3 : Réactivité et communication (Pondération : 15 %)

| Sous-critère                                    | Note /10 | Commentaire |
|-------------------------------------------------|----------|-------------|
| Délai de réponse aux demandes                   | ___/10   |             |
| Qualité des échanges et disponibilité           | ___/10   |             |
| Proactivité dans la communication des problèmes | ___/10  |             |

**Note Critère 3 :** ___/10 x 15 % = ___/15

### Critère 4 : Compétitivité prix (Pondération : 15 %)

| Sous-critère                                    | Note /10 | Commentaire |
|-------------------------------------------------|----------|-------------|
| Positionnement tarifaire par rapport au marché  | ___/10   |             |
| Stabilité des prix sur la période               | ___/10   |             |
| Transparence de la structure de coûts           | ___/10   |             |

**Note Critère 4 :** ___/10 x 15 % = ___/15

### Critère 5 : Capacité et fiabilité (Pondération : 10 %)

| Sous-critère                                    | Note /10 | Commentaire |
|-------------------------------------------------|----------|-------------|
| Capacité de production / prestation             | ___/10   |             |
| Stabilité financière et pérennité               | ___/10   |             |
| Certifications et système qualité              | ___/10   |             |

**Note Critère 5 :** ___/10 x 10 % = ___/10

### Critère 6 : Gestion des non-conformités (Pondération : 10 %)

| Sous-critère                                    | Note /10 | Commentaire |
|-------------------------------------------------|----------|-------------|
| Réactivité de traitement des NC                 | ___/10   |             |
| Qualité de l'analyse cause racine               | ___/10   |             |
| Efficacité des actions correctives              | ___/10   |             |

**Note Critère 6 :** ___/10 x 10 % = ___/10

---

## 3. Synthèse de l'évaluation

### 3.1 Récapitulatif des notes

| N° | Critère                          | Pondération | Note obtenue | Score pondéré |
|----|----------------------------------|-------------|--------------|---------------|
| 1  | Qualité des produits/services    | 30 %        | ___/10       | ___/30        |
| 2  | Respect des délais               | 20 %        | ___/10       | ___/20        |
| 3  | Réactivité et communication      | 15 %        | ___/10       | ___/15        |
| 4  | Compétitivité prix               | 15 %        | ___/10       | ___/15        |
| 5  | Capacité et fiabilité            | 10 %        | ___/10       | ___/10        |
| 6  | Gestion des non-conformités      | 10 %        | ___/10       | ___/10        |
| **TOTAL** |                           | **100 %**   |              | **___/100**   |

### 3.2 Classification A/B/C

| Classification | Score          | Description                                              | Action                          |
|---------------|----------------|----------------------------------------------------------|---------------------------------|
| **A - Excellent** | >= 80/100  | Fournisseur stratégique, performance excellente          | Maintenir, développer le partenariat |
| **B - Acceptable** | 60-79/100 | Performance satisfaisante, axes d'amélioration identifiés | Plan d'amélioration, suivi renforcé |
| **C - Insuffisant** | < 60/100 | Performance insuffisante, risques identifiés             | Plan d'action urgent, envisager remplacement |

### 3.3 Classification attribuée

| Champ                           | Valeur                                           |
|---------------------------------|--------------------------------------------------|
| **Score total**                 | ___/100                                          |
| **Classification**              | [ ] A - Excellent  [ ] B - Acceptable  [ ] C - Insuffisant |
| **Évolution vs évaluation précédente** | [ ] Hausse  [ ] Stable  [ ] Baisse        |

---

## 4. Historique des évaluations

| Date         | Période évaluée    | Score  | Classification | Tendance |
|--------------|--------------------|--------|----------------|----------|
...
## 5. Plan d'action (si classification B ou C)

| N° | Action à mener                      | Responsable (Rôle) | Délai          | Statut           |
|----|-------------------------------------|---------------------|----------------|------------------|
| 1  | ________________________________    | ___________________ | ____/____/____ | [ ] En cours [ ] Clôturé |
| 2  | ________________________________    | ___________________ | ____/____/____ | [ ] En cours [ ] Clôturé |
| 3  | ________________________________    | ___________________ | ____/____/____ | [ ] En cours [ ] Clôturé |
...
| Décision                                                          | Cocher |
|------------------------------------------------------------------|--------|
| Fournisseur maintenu dans le panel sans restriction               | [ ]    |
| Fournisseur maintenu avec plan d'amélioration                     | [ ]    |
| Fournisseur sous surveillance renforcée                           | [ ]    |
| Fournisseur suspendu temporairement                               | [ ]    |
| Fournisseur retiré du panel                                       | [ ]    |
...
| Rôle              | Date              | Signature          |
|-------------------|-------------------|--------------------|
| Achats            | ____/____/____    | __________________ |
...
| **Document**         | Enquête de Satisfaction Client                       |
|----------------------|------------------------------------------------------|
| **Code**            | FM-P01-SAT                                            |
| **Processus**       | P01 - Commercial                                      |
| **Version**         | v0.7                                                  |
| **Date**            | 2026-03-04                                            |
| **Norme ISO 9001**  | Chapitre 9.1.2                                        |
...
| **Pays du client**        | ________________________________________         |
| **Contact client**        | ________________________________________         |
| **E-mail**                | ________________________________________         |
| **Date de l'enquête**     | ________________________________________         |
| **Période évaluée**       | Du ______________ au ______________              |
| **Référence(s) commande** | ________________________________________        |
| **Enquêteur (Rôle)**      | Commercial                                       |

---

## 2. Instructions

Merci de bien vouloir évaluer chaque aspect de nos services sur une échelle de 1 à 5 :
...
## 3. Questionnaire (14 questions - 5 catégories)

### Catégorie A : Qualité des produits/services (3 questions)

| N° | Question                                                                           | 1 | 2 | 3 | 4 | 5 | N/A | Commentaire |
|----|------------------------------------------------------------------------------------|---|---|---|---|---|-----|-------------|
| A1 | Comment évaluez-vous la conformité des produits/services à vos spécifications ?    | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |
| A2 | Comment évaluez-vous la constance de la qualité d'une commande à l'autre ?         | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |
| A3 | Comment évaluez-vous la qualité des rapports d'inspection fournis ?                | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |

**Sous-total Catégorie A :** ___/15 (Moyenne : ___/5)

---

### Catégorie B : Délais et logistique (3 questions)

| N° | Question                                                                           | 1 | 2 | 3 | 4 | 5 | N/A | Commentaire |
|----|------------------------------------------------------------------------------------|---|---|---|---|---|-----|-------------|
| B1 | Comment évaluez-vous le respect des délais de livraison convenus ?                 | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |
| B2 | Comment évaluez-vous la qualité de l'emballage et de la préservation des produits ? | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |
| B3 | Comment évaluez-vous la qualité de la documentation de transport fournie ?          | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |

**Sous-total Catégorie B :** ___/15 (Moyenne : ___/5)

---

### Catégorie C : Communication et réactivité (3 questions)

| N° | Question                                                                           | 1 | 2 | 3 | 4 | 5 | N/A | Commentaire |
|----|------------------------------------------------------------------------------------|---|---|---|---|---|-----|-------------|
| C1 | Comment évaluez-vous la réactivité de nos équipes à vos demandes ?                 | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |
| C2 | Comment évaluez-vous la qualité et la clarté des informations communiquées ?       | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |
| C3 | Comment évaluez-vous le suivi proactif de vos commandes en cours ?                 | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |

**Sous-total Catégorie C :** ___/15 (Moyenne : ___/5)

---

### Catégorie D : Compétence et professionnalisme (3 questions)

| N° | Question                                                                           | 1 | 2 | 3 | 4 | 5 | N/A | Commentaire |
|----|------------------------------------------------------------------------------------|---|---|---|---|---|-----|-------------|
| D1 | Comment évaluez-vous la compétence technique de nos équipes ?                      | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |
| D2 | Comment évaluez-vous notre capacité à comprendre et répondre à vos besoins ?       | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |
| D3 | Comment évaluez-vous notre professionnalisme général dans la conduite des affaires ? | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |

**Sous-total Catégorie D :** ___/15 (Moyenne : ___/5)

---

### Catégorie E : Gestion des problèmes et amélioration (2 questions)

| N° | Question                                                                           | 1 | 2 | 3 | 4 | 5 | N/A | Commentaire |
|----|------------------------------------------------------------------------------------|---|---|---|---|---|-----|-------------|
| E1 | Comment évaluez-vous notre gestion des réclamations et des problèmes rencontrés ? | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |
| E2 | Comment évaluez-vous notre capacité d'amélioration et d'adaptation à vos retours ? | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |             |

**Sous-total Catégorie E :** ___/10 (Moyenne : ___/5)

---

## 4. Synthèse des résultats

### 4.1 Résultats par catégorie

| Catégorie                            | Nb questions | Score obtenu | Score max | Moyenne /5 |
|--------------------------------------|-------------|--------------|-----------|------------|
| A - Qualité des produits/services    | 3           | ___          | 15        | ___/5      |
| B - Délais et logistique             | 3           | ___          | 15        | ___/5      |
| C - Communication et réactivité      | 3           | ___          | 15        | ___/5      |
| D - Compétence et professionnalisme  | 3           | ___          | 15        | ___/5      |
| E - Gestion des problèmes           | 2           | ___          | 10        | ___/5      |
| **TOTAL**                            | **14**      | **___**      | **70**    | **___/5**  |

### 4.2 Score global de satisfaction

| Score moyen /5 | Interprétation                                  |
|----------------|--------------------------------------------------|
| >= 4,5         | Excellent - Client très satisfait                |
| 4,0 - 4,4      | Bon - Client satisfait                          |
| 3,0 - 3,9      | Acceptable - Axes d'amélioration identifiés     |
| 2,0 - 2,9      | Insuffisant - Actions correctives nécessaires    |
| < 2,0          | Critique - Plan d'action urgent requis           |

**Score global obtenu : ___/5 - Interprétation : ________________________________**

---

## 5. Questions ouvertes

### 5.1 Points forts identifiés par le client

________________________________________________________________________
________________________________________________________________________
________________________________________________________________________

### 5.2 Points d'amélioration souhaités par le client

________________________________________________________________________
________________________________________________________________________
________________________________________________________________________

### 5.3 Recommanderiez-vous Plus Sàrl à d'autres entreprises ?
...
## 6. Plan d'action suite à l'enquête

| N° | Axe d'amélioration identifié        | Action prévue                       | Responsable (Rôle) | Délai          |
|----|-------------------------------------|-------------------------------------|---------------------|----------------|
...
## 7. Historique de satisfaction du client

| Date enquête | Période évaluée    | Score global /5 | Tendance                    |
|-------------|--------------------|-----------------|-----------------------------|
...
| Rôle              | Date              | Signature          |
|-------------------|-------------------|--------------------|
| Commercial        | ____/____/____    | __________________ |
| Responsable Qualité | ____/____/____  | __________________ |
