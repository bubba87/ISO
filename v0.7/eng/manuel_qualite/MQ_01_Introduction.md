...
This Quality Manual describes the Quality Management System (QMS) of **Plus Sarl**, in accordance with the requirements of the **ISO 9001:2015** standard.

It constitutes the reference document of the QMS and its objectives are to:

- Define the scope and field of application of the QMS
- Present the organization, processes and their interactions
- Describe the provisions taken to satisfy the requirements of the ISO 9001:2015 standard
...
The QMS of Plus Sarl covers all activities related to **industrial monitoring and worldwide sourcing**, including:
...
In accordance with clause 4.3 of ISO 9001:2015, clause **8.3 (Design and development)** is excluded from the scope. Plus Sarl does not perform product design; the company provides sourcing and quality control of products designed by its customers or suppliers.
...
The Quality Manual is structured according to the chapters of the ISO 9001:2015 standard:
...
- The revision history is tracked in each chapter
...
| **REX**                | Lessons Learned (Retour d'Experience)                                        |
