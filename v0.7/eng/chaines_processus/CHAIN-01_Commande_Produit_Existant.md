...
This document describes the complete process chain for handling an **existing product order** at Plus Sarl. It covers the standard workflow applicable when a customer orders a product already referenced, with an already evaluated supplier and existing tooling.

---

## 2. Scope

This chain applies to any customer order for an existing product in the Plus Sarl catalog, regardless of the geographical location of the customer or the supplier.

---

## 3. Specificities of the "Existing Product" Chain
...
| Detail Ref. | Line           | Actions                                                                                         |
|-------------|----------------|-------------------------------------------------------------------------------------------------|
| CH-BLOC-006 | 02 MANUFACTURE | Send the production confirmation to the supplier (e-mail or messaging)                          |
...
|             | 01 SALES    | 2. Sending the commercial invoice to the carrier                                                 |
|             | 03 DELIVERY | 3. Definition of specific requirements to the supplier if any (deadline, delivery day, etc.)      |
...
|             | 01 SALES   | 2. Sending the invoice to the customer                                                     |
|             | 01 SALES   | 3. Sending the customs declaration to the customer if applicable                            |
|             | 01 SALES   | 4. Customer payment                                                                        |
|             | 01 SALES   | 5. File closure                                                                            |
...
| Rate of files closed on time               | >= 90%                    | Monthly               | Sales Role         |
