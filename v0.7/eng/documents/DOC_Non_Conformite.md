...
| **Detection phase**       | [ ] IPC  [ ] DUPRO  [ ] PSI  [ ] Loading Check  [ ] Receipt  [ ] Other |
...
### 2.1 4-Level Classification System

| Level  | Designation       | Description                                                     | Handling deadline   | Immediate action required           |
|--------|------------------|-----------------------------------------------------------------|---------------------|-----------------------------------|
| **1**  | **Minor**         | Isolated deviation with no significant impact on product conformity or customer satisfaction. The product remains usable. | 30 days | Record. Accept or sort by quantity. |
...
| **4**  | **Critical**      | Deviation compromising product safety, regulatory compliance, or potentially causing serious consequences for the customer. Immediate shipment stop. | Immediate | Record. Block and isolate the entire lot. Immediate stop of all shipments. Alert Management. |
