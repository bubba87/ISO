...
| Code | Processus | Pilote | Objectif |
|---|---|---|---|
| O1 | Commercial | Roxane Wicky (Gerante) | Gerer les relations clients (~10 clients actifs), analyser les besoins, etablir les offres, suivre les commandes |
| O2 | Achats et sous-traitance | Roxane Wicky (Gerante) | Coordonner les partenaires chinois (Yuyao Mould Factory et **Whang**), suivre la production 🟢 |
...
| Code | Processus | Pilote | Objectif |
|---|---|---|---|
| S1 | Gestion documentaire | Roxane Wicky (Gerante) | Maitriser les documents et enregistrements du SMQ (FileMaker, emails, fichiers). Sauvegarde cloud chez le fournisseur 🟢 |
...
```
 ...
 6. ETABLISSEMENT DES DOCUMENTS DE COMMANDE (O1/O2)
    ...
    accuse de reception de commande
            |
            v
 7. LANCEMENT DE LA PRODUCTION (O2 - Achats)
    ...
    Suivi de fabrication (photos, rapports d'etape, echanges WeChat)
            |
            v
 8. CONTROLE QUALITE PRE-EXPEDITION (O2/O4)
    Le partenaire realise un controle qualite avant expedition
    + envoi d'echantillons chez Plus Sarl en parallele du transport
    chez le client
            |
            v
 9. PREPARATION DES DOCUMENTS D'EXPORTATION (O3 - Logistique)
    Documents douaniers, organisation du transport
    (aerien, maritime ou ferroviaire selon urgence et volume)
            |
            v
10. SUIVI DU TRANSPORT (O3 - Logistique)
    Suivi de l'acheminement jusqu'a destination
            |
            v
11. CONFIRMATION DE RECEPTION PAR LE CLIENT (O3/O1)
    Le client confirme la bonne reception des marchandises
            ...
            |
            v
12. FACTURATION ET SUIVI (O1 - Commercial)
