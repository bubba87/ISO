...
La directrice s'engage a mettre en oeuvre, maintenir et ameliorer en continu un Systeme de Management de la Qualite conforme a la norme ISO 9001:2015. L'activite de l'entreprise repose sur la coordination industrielle entre des clients europeens et des partenaires de fabrication chinois. Les priorites sont : la satisfaction client, la conformite des produits, la maitrise des delais et la fiabilite logistique.

### Nos engagements

La directrice s'engage personnellement a :

1. **Traiter toutes les demandes clients** avec reactivite et rigueur.

2. **Assurer la coherence des offres commerciales** et la maitrise des prix.

3. **Coordonner efficacement les partenaires industriels** pour garantir la qualite et la conformite des produits.

4. **Suivre les operations de production, transport et livraison** afin de garantir le respect des delais et des exigences.

5. **Gerer les non-conformites** et mettre en oeuvre des actions preventives.

6. **Proteger la confidentialite** des informations techniques et de la propriete intellectuelle des clients.

7. **Ameliorer en continu** l'organisation, les methodes et la performance du SMQ.
...
- Renforcer le partenariat qualite avec nos fournisseurs chinois (Yuyao Mould Factory et second partenaire)
